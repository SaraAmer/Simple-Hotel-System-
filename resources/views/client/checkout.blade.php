                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" id="payment-form" role="form"
                            ...
                            <div class="form-group{{ $errors->has('ccExpiryMonth') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="ccExpiryMonth" type="text" class="form-control" name="ccExpiryMonth"
                                        value="{{ old('ccExpiryMonth') }}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('ccExpiryYear') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="ccExpiryYear" type="text" class="form-control" name="ccExpiryYear"
                                        value="{{ old('ccExpiryYear') }}" autofocus>
